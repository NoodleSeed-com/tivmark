...
describe('tivmark_assistant', () => {
  ...
  it('publishes business-facing titles for every tool', async () => {
    ...
    expect(titles).toEqual({
      ...
      enterprise_onboarding: 'Inspect enterprise onboarding',
      manage_enterprise_onboarding: 'Update enterprise readiness plan',
      research_onboarding_company: 'Research public company with Google',
