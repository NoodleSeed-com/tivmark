...
// and a version missing from this list would get `invalid_target` instead. v8 through v31 are active;
// v32 is reserved for this branch's rollout so the web authorization server can deploy first. v1-v7
...
const ALLOWED_RESOURCE_LIST = [
  ...
  'https://noodleseed.cloud.noodleseed.dev/tivmark-assistant/v25/mcp',
  'https://noodleseed.cloud.noodleseed.dev/tivmark-assistant/v26/mcp',
  ...
  'https://noodleseed.cloud.noodleseed.dev/tivmark-assistant/v32/mcp',
] as const;
